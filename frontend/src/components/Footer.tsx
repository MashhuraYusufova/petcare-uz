...
export default function Footer() {
  return (
    <footer className="mt-auto py-5" style={{ backgroundColor: "#DDEDFF" }}>
      <Container>
        <Row className="gy-4">
          {/* Brand */}
          <Col lg={3} sm={6}>
            <div className="d-flex flex-column gap-3">
              ...
              <p className="mb-0" style={{ fontSize: '0.75rem', color: "rgba(25, 42, 81, 0.6)" }}>
          ...
          <Col lg={3} sm={6}>
            <div className="d-flex flex-column gap-2">
              ...
              {["Shop", "Vet Booking", "Learn", "Community"].map(l => (
                <Link key={l} href="#" className="text-decoration-none small transition" style={{ color: "#192A51" }} onMouseEnter={(e) => e.currentTarget.style.color = '#4399E1'} onMouseLeave={(e) => e.currentTarget.style.color = '#192A51'}>{l}</Link>
              ))}
            </div>
          </Col>
        ...
        <div className="mt-5 pt-4 border-top" style={{ borderColor: "rgba(67, 153, 225, 0.2)" }}>
          <p className="text-center mb-0 d-flex align-items-center justify-content-center gap-1" style={{ fontSize: '0.75rem', color: "rgba(25, 42, 81, 0.6)" }}>
