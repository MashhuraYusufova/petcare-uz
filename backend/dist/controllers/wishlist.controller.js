...
function addToWishlist(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const item = yield wishlistService.addToWishlist(req.user.userId, productId);
...
function removeFromWishlist(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield wishlistService.removeFromWishlist(req.user.userId, String(req.params.productId));
