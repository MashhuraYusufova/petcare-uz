...
const vetService = __importStar(require("../services/vet.service"));
function getVets(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { spec, district, avail } = req.query;
        try {
            const vets = yield vetService.getAllVets({
...
function getVet(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const vet = yield vetService.getVetById(String(req.params.id));
            res.json(vet);
        }
        catch (err) {
